...
package engine.framework.util
{
    ...
    public class ObjectType /*implements ISerializable*/
    {
         ...
         * 
         * @see engine.frameworks.engine.core.ObjectTypeManager.doesTypeMatch()
         * @see engine.frameworks.engine.core.ObjectTypeManager.doesTypeOverlap()
         * @see engine.frameworks.engine.core.ObjectTypeManager.doTypesMatch()
         * @see engine.frameworks.engine.core.ObjectTypeManager.doTypesOverlap()
         */
