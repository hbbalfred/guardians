 ...
 ******************************************************************************/
package engine.framework.debug
{
    ...
    import engine.framework.core.PBObject;
    import engine.framework.core.PBSet;
    import engine.framework.input.KeyboardKey;
    import engine.framework.input.KeyboardManager;
    import engine.framework.time.ITicked;
    ...
    public class Console extends Sprite implements ILogAppender, ITicked, IPBManager
    {
        ...
        protected function layout():void
        {
            ...
            graphics.clear();
            graphics.beginFill(0x111111, .75);
