 ...
 *  with [PBInject]. When the component is added to a PBGameObject,
 ...
 */
package engine.framework.simplest
{
    ...
    public class SimplestSpriteRenderer extends PBComponent
    {
        ...
        // Any public variable with [PBInject] before it will be injected. stage
