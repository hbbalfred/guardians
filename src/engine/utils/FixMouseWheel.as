package engine.utils
{
	 ...
	 * swfmacmousewheel.js
	 */
	public class FixMouseWheel
	{
		private static var instance:FixMouseWheel;
		
		private var _stage:Stage;
		private var _currItem:InteractiveObject;
		private var _clonedEvent:MouseEvent;
		
		public static function getInstance():FixMouseWheel
		{
			if (instance == null) instance = new FixMouseWheel( new SingletonEnforcer() );
			return instance;
		}
		
		public function FixMouseWheel( enforcer:SingletonEnforcer )
		{
		}
